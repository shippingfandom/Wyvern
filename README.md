# Wyvern
A programming language written in [MiniScript](https://github.com/JoeStrout/miniscript)

Probably what language exactly is it? What features it has to offer over in-game one? Etc, etc...

# Handbook
The handbook is in the `notes` folder

Will remain untouched but there will be more thorough documentation available...

# Installation
There will be two ways to install the **wyvic** compiler:
- Manual (Hand copy from [src](src))
